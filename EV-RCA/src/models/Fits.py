...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.individual:
            ...
            #make freq_upsampler a MLP for better performance
            #self.freq_upsampler = nn.Sequential(
            #    nn.Linear(self.dominance_freq, 128, dtype=torch.cfloat),
            #    nn.Linear(128, int(self.dominance_freq * self.length_ratio), dtype=torch.cfloat)
            #)
